...
ZSH_THEME="robbyrussell" # minimal (I like it!)
#ZSH_THEME=powerlevel10k/powerlevel10k #didn't work for some reason
...
# Services
alias clr="clear"
alias flush="sudo killall -HUP mDNSResponder;sudo killall mDNSResponderHelper;sudo dscacheutil -flushcache" # flush dns
